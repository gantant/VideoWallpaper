...
A lightweight menu bar app that lets you set looping videos as your desktop wallpaper. Built with SwiftUI and AVFoundation, it runs quietly in the background and gives quick access to your video wallpapers through a clean, minimal interface.
